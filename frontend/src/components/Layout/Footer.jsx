    ...
    <div className="bg-[#000] text-white">
      ...
      >
        ...
        <div className="sm:block flex items-center justify-center w-full">
          <img
            src="https://res.cloudinary.com/btechproject2023/image/upload/c_pad,b_auto:predominant,fl_preserve_transparency/v1685096058/BTech%20Project%20Ecommerce%20Web%20App/Payment.jpg?_s=public-apps"
            alt=""
            width={200}
          />
        </div>
